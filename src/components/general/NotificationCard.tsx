        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {notification.contentType === 'vote' && decodedVotedContent ? (
              <div className="mt-2">
                <div className="text-sm [&_.external-image-wrap]:max-w-[20%] [&_.external-image-wrap_p]:hidden [&_.youtube-embed-wrap]:max-w-[20%] [&_.external-video-wrap]:max-w-[20%]">
                ...
                {(countImageUrls(decodedVotedContent) > 1 || countYouTubeUrls(decodedVotedContent) + countVideoFileUrls(decodedVotedContent) > 1) && (
              ...
              <div className="mt-2">
                ...
                {(countImageUrls(decodedContent) > 1 || countYouTubeUrls(decodedContent) + countVideoFileUrls(decodedContent) > 1) && (
                  <div className="mt-2 p-2 bg-muted border-l-4 border-primary rounded-r">
                    <p className="text-xs text-muted-foreground">
                      Click to read more...
                    </p>
